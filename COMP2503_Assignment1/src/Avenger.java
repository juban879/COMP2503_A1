public class Avenger implements Comparable<Avenger>{
	...
	public void setHeroAlias(String heroAlias) { this.heroAlias = heroAlias; }
	
	public String getPerformer() { return performer; }
	public void setPerformer(String performer) { this.performer = performer; }
	
	public int getNameFreq() { return nameFreq; }
	public void setNameFreq(int nameFreq) { this.nameFreq = nameFreq; }
	
	public int getAliasFreq() { return aliasFreq; }
	public void setAliasFreq(int aliasFreq) { this.aliasFreq = aliasFreq; }
	
	public int getPerformerFreq() { return performerFreq;}
	public void setPerformerFreq(int performerFreq) { this.performerFreq = performerFreq; }
